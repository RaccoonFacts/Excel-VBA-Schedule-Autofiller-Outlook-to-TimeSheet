...
Set PLBD = ThisWorkbook.Sheets("PL2 Broken Down")
...
Sub StartEndTimePL2()
    ...
    Set wsBrokenDown = ThisWorkbook.Worksheets("PL2 Broken Down")
    Set wsPaste = ThisWorkbook.Worksheets("PL2 Paste")
    ...
    ' Reuse the exact matching style you used but with normalization + tolerance
...
Sub CalcEmptPL2()
    ...
    Set PLWS = ThisWorkbook.Sheets("PL2 Paste")
    Set PLBD = ThisWorkbook.Sheets("PL2 Broken Down")
...
Sub ExportPL1CopyToNotepad2()
    ...
    'sheet
    Set ws = ThisWorkbook.Sheets("PL2 COPY THIS")
    If ws Is Nothing Then
        MsgBox "Sheet 'PL2 COPY' not found.", vbExclamation
        Exit Sub
    End If
